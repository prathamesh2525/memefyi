      ...
      >
        <div>
          <motion.h1
            ...
            initial={{ x: -500 }}
            animate={{ scale: 2, x: 0 }}
            className="text-lg md:text-xl lg:text-2xl xl:text-4xl text-white font-bold"
          >
            Meme Generator
          </motion.h1>
        </div>
        ...
        <motion.div
          animate={{ scale: 1.5 }}
          className=" px-4 py-2 text-lg md:text-xl lg:text-2xl xl:text-4xl bg-blue-500 hover:bg-blue-700 font-bold text-white rounded-lg cursor-pointer transition duration-200"
        >
